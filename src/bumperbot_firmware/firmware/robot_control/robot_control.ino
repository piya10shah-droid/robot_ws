...
#define L298N_enB 6  // PWM right
#define L298N_in3 39  // Dir Motor B right
...
#define right_encoder_phaseB 41  

#define left_encoder_phaseA 2   // Interrupt
#define left_encoder_phaseB 31
...
void loop() {
  ...
  {
    right_wheel_meas_vel = (10 * right_encoder_counter * (60.0/348.0)) * 0.10472;
